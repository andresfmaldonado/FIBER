    ...
    <form id="form1" class="form-horizontal" runat="server">
        <div class="col-md-6 col-md-offset-3">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <asp:TextBox ID="TextBox1" type="text" class="form-control" placeholder="Código del Hilo" runat="server"></asp:TextBox>
                </div>
            </div>
            <%--<div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <asp:TextBox ID="TextBox2" type="hidden" value="" runat="server"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="3" id="Consumo" placeholder="Consumo del Hilo" runat="server"></textarea>
                </div>
            </div>
            <div class="form-group">
     ...
     <div class="form-group">
         ...
         <div class="col-sm-8">
             <asp:TextBox ID="TextBox4" type="text" class="form-control" placeholder="Nombre Hilo" runat="server"></asp:TextBox>
         </div>
         <div class=" col-md-2">
