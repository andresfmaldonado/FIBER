<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PPedidos.aspx.cs" Inherits="HEXI_ASP.NET.PPedidos" %>
                ...
                <div class="ch-item">
                    <div class="ch-info">
                        ...
                        <div class="ch-info-back">
                            <a href="IFormularioPedidosProductos.aspx">
                                <h3>
                                    Productos
                                </h3>
                                <p>
            ...
            <li>
                <div class="ch-item">
                    <div class="ch-info">
                        ...
                        <div class="ch-info-back">
                            <a href="IFormularioPedidosHilos.aspx">
                                <h3>
                                    Hilos
                                </h3>
                                <p>
