<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PFormularioUsuarios.aspx.cs" Inherits="HEXI_ASP.NET.PFormularioUsurios" %>
...
<body>
  ...
  <div class="jumbotron">
    ...
    <div class="col-md-4 col-md-offset-1">
        <div class="form-group">
            <asp:Label ID="Label11" class="control-label col-sm-3" runat="server" Text="Documento:"></asp:Label>
    <div class="col-sm-9">
  ...
  <div class="form-group">
      <asp:Label ID="Label2" class="control-label col-sm-3" runat="server" Text="Nombre(s):"></asp:Label>
    <div class="col-sm-9"> 
       ...
       <div class="form-group">
           <asp:Label ID="Label3" class="control-label col-sm-3" runat="server" Text="Apellidos:"></asp:Label>
    <div class="col-sm-9"> 
        ...
        <div class="form-group">
            <asp:Label ID="Label10" class="control-label col-sm-3" runat="server" Text="Rol:"></asp:Label>
    <div class="col-sm-9">
        <!--<asp:DropDownList ID="roles" class="form-control col-sm-12" onchange="validacion('roles');" name="roles" runat="server">
        </asp:DropDownList>-->
         <asp:CheckBoxList ID="rolesuser" class="checkbox checkbox-primary" runat="server" onchange="validacion('rolesuser');"></asp:CheckBoxList>
        <span class="help-block"></span>
</div>
    </div>
        </div>
        <div class="col-md-4 col-md-offset-1">
        <div class="form-group">
            <asp:Label ID="Label4" class="control-label  col-sm-3" runat="server" Text="Correo:"></asp:Label>
    <div class="col-sm-9"> 
       ...
       <div class="form-group">
           <asp:Label ID="Label5" class="control-label col-sm-3" runat="server" Text="Contraseña:"></asp:Label>
    <div class="col-sm-9"> 
       ...
       <div class="form-group">
           <asp:Label ID="Label6" class="control-label col-sm-3" runat="server" Text="Contraseña:"></asp:Label>
    <div class="col-sm-9"> 
       ...
       <div class="form-group">
           <asp:Label ID="Label7" class="control-label col-sm-3" runat="server" Text="Teléfono:"></asp:Label>
    <div class="col-sm-9"> 
...
<ControlStyle CssClass="btn btn-warning"></ControlStyle>
    ...
    <script type="text/javascript">
        ...
        function validacion(campo){
                ...
                if (tel == null || tel.length == 0 || /^\s+$/.test(tel)) {
                    ...
                    if (campo === 'foto') {
                        ...
                        if (imagen == null || imagen.length == 0 || /^\s+$/.test(imagen)) {
                            $("#glypcn" + campo).remove();
                            $('#' + campo).parent().parent().attr("class", "form-group has-error has-feedback");
                            $('#' + campo).parent().children('span').text("Ingrese la foto").show();
                            $('#' + campo).parent().append("<span id='glypcn" + campo + "' class='glyphicon glyphicon-remove form-control-feedback'></span>");
                            return false;
            ...
            if (campo === 'rolesuser') {
                var totCount = 0;
                $('#rolesuser').find("input:checkbox").each(function () {
                    if ($(this).prop('checked')) {
                        totCount++;
                    }
                });
                if (totCount <= 0) {
                    $('#rolesuser').parent().parent().attr("class", "form-group has-error");
                    $('#' + campo).parent().children('span').text("Seleccione almenos un rol").show();
                    return false;
                }
                else {
                    $('#rolesuser').parent().parent().attr("class", "form-group has-success");
                    $('#' + campo).parent().children('span').hide();
                    return true;
