<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignPatrones.aspx.cs" Inherits="HEXI_ASP.NET.DesignPatrones" %>
    ...
    <div class="col-lg-12">
        <div class="col-sm-2 col-md-2 col-lg-2" id="menud">
            <ul class="nav nav-pills nav-stacked options text-center">
                <li class="mb"><img src="Iconos/profile.jpg" width="80px" style="border-radius: 100%;margin-top: 2rem;background-color: #fcf8e3;
    border: 1px solid #333; padding: 2px" />
                    <h5>Juan Ortiz Lopera</h5><label class="label label-primary">Área textil</label></li>
